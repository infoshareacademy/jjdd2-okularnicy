...
<div class="og" id="boxy">
    ...
    <c:if test="${lstCorrectness == 0}"><H3 class="warning">Uwaga! Archiwum zip nie zawiera wszystkich plików zapisanych
        na liście LST. Nadal możesz korzystać z aplikacji, ale lista wyboru została ograniczona do plików które znajdują
        się w archiwum</H3></c:if>
